...
pub mod get_info {
    ...
    impl MockBuilder200 {
        ...
        pub fn with_responses(
            mut self,
            response_body: get_info::Response200,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_200() -> MockBuilder200 {
        MockBuilder200::new()
    }
}
...
pub mod get_meal_plans {
    ...
    impl MockBuilder200 {
        #[allow(clippy::new_without_default)]
        pub fn new(parameters: &get_meal_plans::Parameters) -> Self {
            let url = "/meal_plans".to_string();
            Self {
                counter: Arc::new(AtomicUsize::new(0)),
                responses: Vec::new(),
                url,
        ...
        pub fn with_response(mut self, response_body: get_meal_plans::Response200) -> Self {
            self.responses.push(json!(response_body).to_string());
            self
        }
        ...
        pub fn with_responses(
            mut self,
            response_body: get_meal_plans::Response200,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_200(parameters: &get_meal_plans::Parameters) -> MockBuilder200 {
...
pub mod update_meal_plans {
    ...
    pub struct MockBuilder200 {
        counter: Arc<AtomicUsize>,
        responses: Vec<String>,
        request_body: Option<update_meal_plans::Body>,
        url: String,
    }
    ...
    impl MockBuilder200 {
        ...
        pub fn new(
            ...
            body: Option<update_meal_plans::Body>,
        ) -> Self {
            let url = "/meal_plans".to_string();
            Self {
                counter: Arc::new(AtomicUsize::new(0)),
        ...
        pub fn with_response(mut self, response_body: update_meal_plans::Response200) -> Self {
            self.responses.push(json!(response_body).to_string());
            self
        }
        ...
        pub fn with_responses(
            mut self,
            response_body: update_meal_plans::Response200,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
...
pub mod get_recipes {
    ...
    impl MockBuilder200 {
        #[allow(clippy::new_without_default)]
        pub fn new(parameters: &get_recipes::Parameters) -> Self {
            let url = "/recipes".to_string();
            Self {
                counter: Arc::new(AtomicUsize::new(0)),
                responses: Vec::new(),
                url,
        ...
        pub fn with_responses(
            mut self,
            response_body: get_recipes::Response200,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_200(parameters: &get_recipes::Parameters) -> MockBuilder200 {
        MockBuilder200::new(parameters)
    }
    ...
    impl MockBuilder401 {
        ...
        pub fn with_responses(
            mut self,
            response_body: get_recipes::Response401,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_401(parameters: &get_recipes::Parameters) -> MockBuilder401 {
    ...
    impl MockBuilder403 {
        ...
        pub fn with_responses(
            mut self,
            response_body: get_recipes::Response403,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_403(parameters: &get_recipes::Parameters) -> MockBuilder403 {
...
pub mod add_recipe {
    ...
    pub struct MockBuilder200 {
        counter: Arc<AtomicUsize>,
        responses: Vec<String>,
        request_body: Option<add_recipe::Body>,
        url: String,
    }

    impl MockBuilder200 {
        #[allow(clippy::new_without_default)]
        pub fn new(parameters: &add_recipe::Parameters, body: Option<add_recipe::Body>) -> Self {
            let url = "/recipes".to_string();
            Self {
                counter: Arc::new(AtomicUsize::new(0)),
                responses: Vec::new(),
        ...
        pub fn with_responses(
            mut self,
            response_body: add_recipe::Response200,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
...
pub mod get_recipe_by_id {
    ...
    impl MockBuilder200 {
        #[allow(clippy::new_without_default)]
        pub fn new(parameters: &get_recipe_by_id::Parameters) -> Self {
            let url = format!("/recipes/{recipe_id}", recipe_id = parameters.recipe_id);
            Self {
                counter: Arc::new(AtomicUsize::new(0)),
                responses: Vec::new(),
                url,
        ...
        pub fn with_responses(
            mut self,
            response_body: get_recipe_by_id::Response200,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_200(parameters: &get_recipe_by_id::Parameters) -> MockBuilder200 {
        MockBuilder200::new(parameters)
    }
    pub struct MockBuilder401 {
        counter: Arc<AtomicUsize>,
    ...
    impl MockBuilder401 {
        ...
        pub fn with_responses(
            mut self,
            response_body: get_recipe_by_id::Response401,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_401(parameters: &get_recipe_by_id::Parameters) -> MockBuilder401 {
        MockBuilder401::new(parameters)
    }
    pub struct MockBuilder403 {
        counter: Arc<AtomicUsize>,
    ...
    impl MockBuilder403 {
        ...
        pub fn with_responses(
            mut self,
            response_body: get_recipe_by_id::Response403,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_403(parameters: &get_recipe_by_id::Parameters) -> MockBuilder403 {
        MockBuilder403::new(parameters)
    }
    ...
    impl MockBuilder404 {
        ...
        pub fn with_responses(
            mut self,
            response_body: get_recipe_by_id::Response404,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_404(parameters: &get_recipe_by_id::Parameters) -> MockBuilder404 {
...
pub mod update_recipe_by_id {
    ...
    pub struct MockBuilder200 {
        counter: Arc<AtomicUsize>,
        responses: Vec<String>,
        request_body: Option<update_recipe_by_id::Body>,
        url: String,
    }
    ...
    impl MockBuilder200 {
        ...
        pub fn new(
            ...
            body: Option<update_recipe_by_id::Body>,
        ) -> Self {
            let url = format!("/recipes/{recipe_id}", recipe_id = parameters.recipe_id);
            Self {
                counter: Arc::new(AtomicUsize::new(0)),
        ...
        pub fn with_responses(
            mut self,
            response_body: update_recipe_by_id::Response200,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    impl MockBuilder401 {
        ...
        pub fn with_responses(
            mut self,
            response_body: update_recipe_by_id::Response401,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    impl MockBuilder403 {
        ...
        pub fn with_responses(
            mut self,
            response_body: update_recipe_by_id::Response403,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    impl MockBuilder404 {
        ...
        pub fn with_responses(
            mut self,
            response_body: update_recipe_by_id::Response404,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
...
pub mod delete_recipe_by_id {
    ...
    impl MockBuilder200 {
        #[allow(clippy::new_without_default)]
        pub fn new(parameters: &delete_recipe_by_id::Parameters) -> Self {
            let url = format!("/recipes/{recipe_id}", recipe_id = parameters.recipe_id);
            Self {
                counter: Arc::new(AtomicUsize::new(0)),
                responses: Vec::new(),
        ...
        pub fn with_responses(
            mut self,
            response_body: delete_recipe_by_id::Response200,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_200(parameters: &delete_recipe_by_id::Parameters) -> MockBuilder200 {
        MockBuilder200::new(parameters)
    }
    pub struct MockBuilder401 {
        counter: Arc<AtomicUsize>,
    ...
    impl MockBuilder401 {
        ...
        pub fn with_responses(
            mut self,
            response_body: delete_recipe_by_id::Response401,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_401(parameters: &delete_recipe_by_id::Parameters) -> MockBuilder401 {
        MockBuilder401::new(parameters)
    }
    pub struct MockBuilder403 {
        counter: Arc<AtomicUsize>,
    ...
    impl MockBuilder403 {
        ...
        pub fn with_responses(
            mut self,
            response_body: delete_recipe_by_id::Response403,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_403(parameters: &delete_recipe_by_id::Parameters) -> MockBuilder403 {
        MockBuilder403::new(parameters)
    }
    pub struct MockBuilder404 {
        counter: Arc<AtomicUsize>,
    ...
    impl MockBuilder404 {
        ...
        pub fn with_responses(
            mut self,
            response_body: delete_recipe_by_id::Response404,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_404(parameters: &delete_recipe_by_id::Parameters) -> MockBuilder404 {
        MockBuilder404::new(parameters)
    }
}
...
pub mod get_shopping_list {
    ...
    impl MockBuilder200 {
        #[allow(clippy::new_without_default)]
        pub fn new(parameters: &get_shopping_list::Parameters) -> Self {
            let url = "/shopping_list".to_string();
            Self {
                counter: Arc::new(AtomicUsize::new(0)),
                responses: Vec::new(),
                url,
        ...
        pub fn with_response(mut self, response_body: get_shopping_list::Response200) -> Self {
            self.responses.push(json!(response_body).to_string());
            self
        }
        ...
        pub fn with_responses(
            mut self,
            response_body: get_shopping_list::Response200,
            expect: usize,
        ) -> Self {
            self.responses
                .extend(std::iter::repeat(json!(response_body).to_string()).take(expect));
    ...
    pub fn mock_200(parameters: &get_shopping_list::Parameters) -> MockBuilder200 {
        MockBuilder200::new(parameters)
    }
}
